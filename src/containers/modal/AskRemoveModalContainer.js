...
class AskRemoveModalContainer extends Component {
    _handleCancle = () => {
        console.log('_call_handelCancel');
    ...
    _handleConfirm = async () => {
        ...
        console.log('_call_handelConfirm');

        try {
            // 포스트 삭제 후, 모달 닫고 사이트로 이동
    ...
    render() {
        ...
        const { _handleCancle, _handleConfirm} = this;

        return (
            <AskRemoveModal visible={visible} onCancle={_handleCancle} onConfirm={_handleConfirm} />
        );
    }
}
